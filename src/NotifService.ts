...
export default class NotifService {
  private lastId;
  private lastChannelCounter;

  constructor(onRegister: Fn, onNotification: Fn) {
    this.lastId = 0;
  ...
  checkPermission(
    cbk: Parameters<typeof PushNotification.checkPermissions>[0],
  ) {
  ...
  cancelNotif() {
    PushNotification.cancelLocalNotification(String(this.lastId));
  }
  ...
  getScheduledLocalNotifications(
    callback: Parameters<
      typeof PushNotification.getScheduledLocalNotifications
    >[0],
  ) {
  ...
  getDeliveredNotifications(
    callback: Parameters<typeof PushNotification.getDeliveredNotifications>[0],
  ) {
